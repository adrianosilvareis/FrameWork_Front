...
class Check {
    ...
    public static function Name($Name) {
        self::$Format = array();
        self::$Format['a'] = 'Ã€Ã�Ã‚ÃƒÃ„Ã…Ã†Ã‡ÃˆÃ‰ÃŠÃ‹ÃŒÃ�ÃŽÃ�Ã�Ã‘Ã’Ã“Ã”Ã•Ã–Ã˜Ã™ÃšÃ›ÃœÃ¼Ã�ÃžÃŸÃ Ã¡Ã¢Ã£Ã¤Ã¥Ã¦Ã§Ã¨Ã©ÃªÃ«Ã¬Ã­Ã®Ã¯Ã°Ã±Ã²Ã³Ã´ÃµÃ¶Ã¸Ã¹ÃºÃ»Ã½Ã½Ã¾Ã¿Rr"!@#$%&*()_-+={[}]/?;:.,\\\'<>Â°ÂºÂª';
    ...
    public static function UserOnline() {
        ...
        $deleteUserOnline->delete("online_endview < :online_endview");
        $deleteUserOnline->findAll();

        return $deleteUserOnline->getRowCount();
    }
