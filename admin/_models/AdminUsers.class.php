...
class AdminUsers {
    ...
    private function setNome() {
        ...
        $this->Read->Query("WHERE {$Where} #user_email#");
    ...
    private function Create() {
        ...
        $this->Messagem("cadastrada", $this->Read->getLastId('user_id'), $insert);
    }
    ...
    private function Update() {
        ...
        $this->Messagem("atualizada", $this->Read->getLastId('user_id'), $update);
    }
