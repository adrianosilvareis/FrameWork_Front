...
class AdminEmpresa {
    ...
    private function setName() {
        ...
        $Read->Query("WHERE {$Where} #empresa_title#");
    ...
    private function checkCover() {
        ...
        $readCapa->FullRead("id={$this->Empresa}", "SELECT empresa_capa FROM app_empresas WHERE empresa_id = :id", "id={$this->Empresa}");
