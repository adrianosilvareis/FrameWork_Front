                ...
                <article<?php if ($empi % 2 == 0) echo ' class="right"'; ?> <?= $status; ?>>
                    ...
                    <ul class="info post_actions">
                        ...
                        <?php if (!$empresa_status): ?>
                            <li><a class="act_ative" href="painel.php?exe=empresas/index&emp=<?= $empresa_id; ?>&action=active" title="Ativar">Ativar</a></li>
                        <?php else: ?>
                            <li><a class="act_inative" href="painel.php?exe=empresas/index&emp=<?= $empresa_id; ?>&action=inative" title="Inativar">Inativar</a></li>
                        <?php endif; ?>
